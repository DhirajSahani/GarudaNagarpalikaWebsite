    ...
    return (
        <div>
            ...
            Act, law and directives
                   ...
                   गरुडा नगरपालिकाको आय ठेक्का कार्यविधि २०८१ राजपत्र|
                    </h2>
                    <p className='mt-4 font-semibold text-sm sm:text-base'>Post date: 03/07/2025 - 15:18
Document:</p>
                    <a
                        href="https://drive.google.com/file/d/1pYVQFpHlCHMUoQ-_RmQK46MPTAQNnJ1W/view?usp=sharing"
                        target="_blank"
                    ...
                    >
                        📄  गरुडा नगरपालिकाको आय ठेक्का कार्यविधि २०८१ राजपत्र. PDF
                    </a>
                </div>

                <div className='p-4 sm:p-6 md:p-8'>
                    <h2 className='font-bold text-base sm:text-xl md:text-2xl mt-4 border-b-2 border-gray-300 pb-2'>
                        गरुडा नगरपालिका व्यवसाय दर्ता, नवीकरण तथा कर सम्बन्धी कार्यविधि, २०८१ राजपत्र|
                    </h2>
                    <p className='mt-4 font-semibold text-sm sm:text-base'>Post date: 03/07/2025 - 15:17
Document:</p>
                    <a
                        ...
                        className="inline-block mt-2 px-3 sm:px-4 py-2 bg-pink-500 text-white text-sm sm:text-base font-bold rounded-lg shadow hover:bg-red-700"
                    >
                        📄 गरुडा नगरपालिका व्यवसाय दर्ता, नवीकरण तथा कर सम्बन्धी कार्यविधि, २०८१ राजपत्र.PDF
                    </a>
                </div>

                <div className='p-4 sm:p-6 md:p-8'>
                    <p className='mt-3 font-bold text-lg sm:text-xl md:text-2xl'>
                       गरुडा नगरपालिका मेलमिलाप केन्द्र सञ्चालन सम्बन्धी कार्यविधि, २०८१ राजपत्र|
                    </p>
                    <p className='mt-4 font-semibold text-sm sm:text-base'>Post date: 03/07/2025 - 15:16
Document:</p>
                    <a
                        href="https://drive.google.com/file/d/1Dtfcut7M5uvXiYCGzGxfgiAHgYOo3UUq/view?usp=sharing"
                        target="_blank"
                        ...
                        className="inline-block mt-2 px-3 sm:px-4 py-2 bg-pink-500 text-white text-sm sm:text-base font-bold rounded-lg shadow hover:bg-red-700"
                    >
                        📄 गरुडा नगरपालिका मेलमिलाप केन्द्र सञ्चालन सम्बन्धी कार्यविधि, २०८१ राजपत्र. PDF
                    </a>
                </div>
                    <div className='p-4 sm:p-6 md:p-8'>
                    <p className='mt-3 font-bold text-lg sm:text-xl md:text-2xl'>
                       गरुडा नगरपालिका तालिम सञ्चालन कार्यविधि २०८१ राजपत्र|
                    </p>
                    <p className='mt-4 font-semibold text-sm sm:text-base'>Post date: 03/07/2025 - 15:15
Document:</p>
                    <a
                        href="https://drive.google.com/file/d/1Dtfcut7M5uvXiYCGzGxfgiAHgYOo3UUq/view?usp=sharing"
                        target="_blank"
                        ...
                        className="inline-block mt-2 px-3 sm:px-4 py-2 bg-pink-500 text-white text-sm sm:text-base font-bold rounded-lg shadow hover:bg-red-700"
                    >
                        📄 गरुडा नगरपालिका तालिम सञ्चालन कार्यविधि २०८१ राजपत्र. PDF
                    </a>
                </div>
                    <div className='p-4 sm:p-6 md:p-8'>
                    <p className='mt-3 font-bold text-lg sm:text-xl md:text-2xl'>
                       गरुडा नगरपालिका कृषि अनुदान उपलब्ध गराउने सम्बन्धी कार्यविधि २०८१ राजपत्र|
                    </p>
                    <p className='mt-4 font-semibold text-sm sm:text-base'>Post date: 03/07/2025 - 14:12
Document:</p>
                    <a
                        href="https://drive.google.com/file/d/1Dtfcut7M5uvXiYCGzGxfgiAHgYOo3UUq/view?usp=sharing"
                        target="_blank"
                        ...
                        className="inline-block mt-2 px-3 sm:px-4 py-2 bg-pink-500 text-white text-sm sm:text-base font-bold rounded-lg shadow hover:bg-red-700"
                    >
                        📄 गरुडा नगरपालिका कृषि अनुदान उपलब्ध गराउने सम्बन्धी कार्यविधि २०८१ राजपत्र . PDF
                    </a>
                </div>
                         <div className='p-4 sm:p-6 md:p-8'>
                    <p className='mt-3 font-bold text-lg sm:text-xl md:text-2xl'>
                       गरुडा नगरपालिकाको विनियोजन ऐन, २०८१ राजपत्र|
                    </p>
                    <p className='mt-4 font-semibold text-sm sm:text-base'>Post date: 11/25/2024 - 11:48
Document:</p>
                    <a
                        href="https://drive.google.com/file/d/1Dtfcut7M5uvXiYCGzGxfgiAHgYOo3UUq/view?usp=sharing"
                        target="_blank"
                        ...
                        className="inline-block mt-2 px-3 sm:px-4 py-2 bg-pink-500 text-white text-sm sm:text-base font-bold rounded-lg shadow hover:bg-red-700"
                    >
                        📄 गरुडा नगरपालिकाको विनियोजन ऐन, २०८१ राजपत्र. PDF
                    </a>
                </div>
                <div className='p-4 sm:p-6 md:p-8'>
                    <p className='mt-3 font-bold text-lg sm:text-xl md:text-2xl'>
                       गरुडा आर्थिक ऐन २०८१ राजपत्र|
                    </p>
                    <p className='mt-4 font-semibold text-sm sm:text-base'>Post date: 11/25/2024 - 11:48
Document:</p>
                    <a
                        ...
                        className="inline-block mt-2 px-3 sm:px-4 py-2 bg-pink-500 text-white text-sm sm:text-base font-bold rounded-lg shadow hover:bg-red-700"
                    >
                        📄 गरुडा आर्थिक ऐन २०८१ राजपत्र. PDF
                    </a>
                </div>
                    <div className='p-4 sm:p-6 md:p-8'>
                    <p className='mt-3 font-bold text-lg sm:text-xl md:text-2xl'>
                       गरुडा नगरपालिका कर्मचारी अवकाश कोष सञ्चालन कार्यविधि, २०८०|
                    </p>
                    <p className='mt-4 font-semibold text-sm sm:text-base'>Post date: 11/24/2024 - 16:45
Document:</p>
                    <a
                        href="https://drive.google.com/file/d/1Dtfcut7M5uvXiYCGzGxfgiAHgYOo3UUq/view?usp=sharing"
                        target="_blank"
                        ...
                        className="inline-block mt-2 px-3 sm:px-4 py-2 bg-pink-500 text-white text-sm sm:text-base font-bold rounded-lg shadow hover:bg-red-700"
                    >
                        📄 गरुडा नगरपालिका कर्मचारी अवकाश कोष सञ्चालन कार्यविधि, २०८०. PDF
                    </a>
                </div>
                    <div className='p-4 sm:p-6 md:p-8'>
                    <p className='mt-3 font-bold text-lg sm:text-xl md:text-2xl'>
                      नगर कार्यपालिकाको बैठक संचालन सम्बन्धी कार्यविधि–२०८०|
                    </p>
                    <p className='mt-4 font-semibold text-sm sm:text-base'>Post date: 11/24/2024 - 16:44
Document:</p>
                    <a
                        href="https://drive.google.com/file/d/1Dtfcut7M5uvXiYCGzGxfgiAHgYOo3UUq/view?usp=sharing"
                        target="_blank"
                        ...
                        className="inline-block mt-2 px-3 sm:px-4 py-2 bg-pink-500 text-white text-sm sm:text-base font-bold rounded-lg shadow hover:bg-red-700"
                    >
                        📄 नगर कार्यपालिकाको बैठक संचालन सम्बन्धी कार्यविधि–२०८० PDF
                    </a>
                </div>
                    <div className='p-4 sm:p-6 md:p-8'>
                    <p className='mt-3 font-bold text-lg sm:text-xl md:text-2xl'>
                       सार्वजनिक जवाफदेहिता प्रवद्र्धन सम्बन्धी कार्यविधि, २०८०|
                    </p>
                    <p className='mt-4 font-semibold text-sm sm:text-base'>Post date: 11/24/2024 - 16:44
Document:</p>
                    <a
                        ...
                        className="inline-block mt-2 px-3 sm:px-4 py-2 bg-pink-500 text-white text-sm sm:text-base font-bold rounded-lg shadow hover:bg-red-700"
                    >
                        📄 सार्वजनिक जवाफदेहिता प्रवद्र्धन सम्बन्धी कार्यविधि, २०८०. PDF
                    </a>
                </div>
            </div>
            <Footer />
