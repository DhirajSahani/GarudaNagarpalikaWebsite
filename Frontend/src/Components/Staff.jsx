        ...
        <h1 className="text-3xl font-semibold text-center mx-auto  ">Latest Blog</h1>
            ...
            <div className="flex items-center justify-center gap-8 pt-12 flex-wrap ">
                <div className="max-w-72 w-full hover:-translate-y-0.5 transition duration-300">
                    ...
                    <h3 className="text-base text-slate-900 font-medium mt-3">सरोज गौतम</h3>
                    <p className="text-xs text-indigo-600 font-medium mt-1">शिक्षा अधिकृत (सातौँ)</p>
                    <p className="text-xs text-indigo-600 font-medium mt-1">शिक्षा शाखा प्रमुख</p>
                    <p className="text-xs text-indigo-600 font-medium mt-1">gautamsaroj858@gmail.com</p>
                    <p className="text-xs text-indigo-600 font-medium mt-1">9849637568</p>
                </div>
                <div className="max-w-72 w-full hover:-translate-y-0.5 transition duration-300">
